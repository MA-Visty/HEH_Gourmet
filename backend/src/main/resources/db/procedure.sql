...
create procedure heh.add_vendor(
    in p_last_name varchar(255),
    in p_first_name varchar(255),
    in p_email varchar(255),
    in p_password varchar(255)
...
create procedure heh.add_admin(
    in p_last_name varchar(255),
    in p_first_name varchar(255),
    in p_email varchar(255),
    in p_password varchar(255)
...
create procedure heh.remove_user(
    in p_user_id int
)
begin
    delete
...
create procedure heh.edit_user(
    in p_user_id int,
    in p_last_name varchar(255),
    in p_first_name varchar(255),
    in p_email varchar(255),
...
create procedure heh.add_product_with_new_category(
...
begin
    -- add category
    heh.add_category(p_category_name, p_category_description);
    -- get category id
    set @category_id = last_insert_id();
    -- add product
    heh.add_product(p_name, p_description, p_price, ifnull(p_stock, 1), p_image,
                    @category_id);
end;

-- Procedure to add a product with an existing category
create procedure heh.add_product(
    in p_name varchar(255),
    in p_description longtext,
    in p_price decimal,
    in p_stock int,
...
create procedure heh.remove_product(
    in p_id int
)
begin
    -- remove product
...
create procedure heh.edit_product(
    in p_id int,
    in p_name varchar(255),
    in p_description longtext,
    in p_price decimal,
...
create procedure heh.add_category(
    in p_name varchar(255),
    in p_description longtext
)
begin
...
create procedure heh.remove_category(
    in p_id int
)
begin
    -- remove category
...
create procedure heh.edit_category(
    in p_id int,
    in p_name varchar(255),
    in p_description longtext
)
...
create procedure heh.add_product_to_cart(
    in p_user_id int,
    in p_product_id int,
    in p_quantity int
)
...
create procedure heh.remove_product_from_cart(
    in p_user_id int,
    in p_product_id int
)
begin
